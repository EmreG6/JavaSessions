...
public class C08_NestedIF {
	...
	public static void main(String[] args) {
		...
		char cinsiyet=scan.next().toUpperCase().charAt(0); //toUpper büyük harf icin yazýlýyor
		...
		if (cinsiyet=='E') {
			if (yas>=65) {
				...
				System.out.println("Emekli olamazýsnýz");
			...
			if (yas>=60) {
				...
				System.out.println("Emekli olabmazsýnýz");
			}
