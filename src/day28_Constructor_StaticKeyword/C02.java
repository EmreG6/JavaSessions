...
public class C02 {
	...
	public static void main(String[] args) {
		// 3 tane obje olusturalimve degisimleri gozlemleyelim
		...
		// ayni class icindeyken static variable'lara ulasmak icin obje'ye ihtiyac yoktur
		// kullanirsak java cte vermez fakat "static variable'astatic yoldan ulas"der
		System.out.println("islemden sonra obje icin x :" + obje1.x + " obje icin y :" + y);
