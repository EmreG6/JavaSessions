...
public class C01_Equals {
	...
	public static void main(String[] args) {
		...
		char ch1='K';
		char ch2='K'+0;
		System.out.println(ch1==ch2); //char ASCII degerleri üzerinden degerlendirme yapar
		...
		//String variable'larda == hem degere hem referansa bakar dolayýsýyla 
		//objeler farklý oldugunda genelde false doner
